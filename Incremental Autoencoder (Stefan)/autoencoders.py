...
class LargeIncrementalAutoEncoder(nn.Module):
    def __init__(self):
        super(LargeIncrementalAutoEncoder, self).__init__()
...
class LargeRandomAutoEncoder(nn.Module):
    def __init__(self):
        super(LargeRandomAutoEncoder, self).__init__()
